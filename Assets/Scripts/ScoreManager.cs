...
public class ScoreManager : MonoBehaviour
{
    ...
    {
        if (score >= 9000) return 9; // 副社長
        if (score >= 8000) return 8; // 専務
        if (score >= 7000) return 7; // 常務
        if (score >= 6000) return 6; // 本部長
        if (score >= 5000) return 5; // 部長
        if (score >= 4000) return 4; // 次長
